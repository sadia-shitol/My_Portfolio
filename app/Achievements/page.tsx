        ...
        <div className='flex flex-wrap gap-2 mt-4'>
          {achievement.certificateImage &&
            achievement.category === 'certification' && (
              <Button
                ...
                onClick={() =>
                  openImage(achievement.title, achievement.certificateImage!)
                }
              >
                <ImageIcon size={14} />
                View Certificate
          ...
          {achievement.pictureImage && achievement.category === 'award' && (
            <Button
              ...
              onClick={() =>
                openImage(achievement.title, achievement.pictureImage!)
              }
            >
              <Image size={14} />
              Picture
    ...
    <main className='min-h-screen bg-white pt-24 pb-16'>
      <div className='container mx-auto px-4 max-w-4xl'>
        ...
        <p className='text-forest-900/80 max-w-3xl mb-12'>
          A collection of my professional achievements, certifications,
...
//           </TabsContent> */}
        ...
        <div className='mt-16 text-center'>
          ...
          <Link href='/experience'>
            <Button
              size='lg'
              className='transform transition-all border-[0.02px] hover:border-forest-900 hover:bg-white hover:text-forest-900 bg-forest-950 text-white duration-300 hover:scale-105 hover:brightness-110 hover:shadow-lg'
            >
