...
const projects = [
  ...
  },
  {
    ...
    demoUrl:
      'https://drive.google.com/file/d/1jMoBRS2WIZR7uoH9tmdsuD9gJb5eYX-d/view?t=1',
  ...
  },
  {
    ...
    title: 'FurniHaven',
    description:
      'A mobile app that connects consumers and sellers in the furniture industry, integrating AR technology and AI recommendation system.',
  ...
  },
  {
    ...
    demoUrl:
      'https://drive.google.com/file/d/1wlNPVvP07GkZYxjPVpezDsw8X3lGjfV1/view?t=1',
    ...
    challenges: ['There were no limitations regarding the project'],
    solutions: [
...

  {
    ...
    longDescription:
      'This project showcases my educational qualifications, achievements, experiences, expertises',
    image: '../images/portfolio.png?height=400&width=600',
    tags: ['React', 'Next.js', 'Tailwind CSS', 'Typescript'],
    detailsUrl: 'projects/portfolio',
    demoUrl:
      'https://my-portfolio-wpv9-wbm0zr5aq-sadia-shitols-projects.vercel.app/',
    codeUrl: 'https://github.com/sadia-shitol/My_Portfolio',
    features: [
      'Basically a demonstration of  my education, expertise, experiences and achievements.',
    ],
    challenges: ['Hosting the website'],
    solutions: [' Will try to add more detailes'],
  },
]
    ...
    return (
      <main className='min-h-screen bg-white pt-24 pb-16'>
        <div className='container mx-auto px-4 max-w-4xl'>
          ...
          <div className='mt-8'>
            <Link href='/projects'>
              <Button className='bg-forest-900 hover:bg-forest-800 text-white'>
                Back to Projects
              </Button>
            </Link>
          </div>
    ...
    <main className='min-h-screen bg-white pt-12 pb-16'>
      <div className='container mx-auto px-4 max-w-4xl'>
        ...
        <div className='flex flex-wrap gap-3 mb-8'>
          ...
          <Button
            className='gap-2 border-[0.02px] bg-forest-900 hover:bg-white hover:border-forest-950 hover:text-black text-white'
            asChild
          >
        ...
        <div className='flex justify-between items-center pt-8 border-t border-gray-100'>
          <Link href='/projects'>
            <Button
              variant='outline'
              className='gap-2  border-forest-900 text-forest-900 hover:bg-forest-900 hover:text-white'
            >
              <ArrowLeft size={16} />
              Back to Projects
            </Button>
          ...
          <Link href='/#contact'>
            <Button className='gap-2 border-[0.02px] bg-forest-900 hover:bg-white hover:border-forest-950 hover:text-black text-white'>
