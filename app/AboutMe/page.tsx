      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="flex items-center mb-8">
          <Link href="/" className="mr-4">
            <Button variant="ghost" size="icon" className="text-forest-900 hover:bg-forest-900/10 hover:border-forest-800">
              <ArrowLeft size={20} />
            </Button>
          </Link>
        ...
        <section className="mb-16">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <Image  src="/images/shitol.jpg"  alt="Sadia Bintay Mostafiz"
            fill
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8 ">
            {education.map((edu) => (
              <Card key={edu.id} className="border-[0.01px] shadow-md border-forest-900 ">
                <CardHeader>
                ...
                <CardContent>
                  {edu.description && <p className="text-forest-900/90 mb-4">{edu.description}</p>}
