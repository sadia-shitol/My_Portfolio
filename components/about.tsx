    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex gap-2">
              {[
                ...
                { icon: <Instagram size={20} />, label: "LinkedIn" ,url:"https://www.instagram.com/_shitol_sadia/"},
          ...
          <div className="mt-4">
            <Button variant="outline" className="border-forest-900 text-forest-900 transform transition-all duration-300 hover:scale-105 hover:brightness-110 hover:shadow-lg  hover:border-forest-700" asChild>
